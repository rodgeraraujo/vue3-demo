<template>
  <div
    ref="el"
    class="bg-gray-800 radius-sm shadow-lg rounded-md h-full transition duration-500 ease-in-out hover:bg-teal-900 transform hover:-translate-y-1 hover:scale-110"
  >
...
export default {
  ...
  setup(props, context) {
    ...
    return { gameData: props.game, platforms, el, isIntersecting };
  },
};
</script>