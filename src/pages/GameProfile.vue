<template>
  <section
    v-if="!loading"
    class="grid grid-cols-2 py-16 px-32 gap-4"
  >
    <aside class="max-w-screen-sm">
      ...
      <p class="opacity-75 mb-5">
        <strong>Release Date:</strong> {{ dateReleased }}
      </p>
      <p
    ...
    <div class="p-5 max-w-screen-sm bg-gray-800 radius-lg shadow-lg">
      <h4 class="text-3xl font-semibold">
        About
      </h4>
      <p v-html="gameDetails.description" />
    </div>
